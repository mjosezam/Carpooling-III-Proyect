...
public class DiGraphTest
{
    public static void main(String[] args){
        ...
        String[] lugares = {"dulce_nombre","occidental","oriental","el_tejar","el_guarco","tierra_blanca","carmen","guadalupe",
                "san_nicolas","agua_caliente","turrialba","tucurrique","concepcion","san_rafael","cot","pacayas","cervantes"};

        //CREAR METODO QUE ASIGNE RUTAS DE FORMA ALEATORIA Y PESOS SIN QUE SE ASIGNE A SI MISMO UN PESO
